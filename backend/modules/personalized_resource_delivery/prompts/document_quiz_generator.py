...
⚠️ You MUST complete the ENTIRE JSON object from start to finish.
⚠️ Do NOT stop generating until ALL closing braces }} and brackets ]] are added.
⚠️ Ensure every string is properly closed with quotes.
⚠️ The JSON MUST be syntactically complete and valid.
...
Remember: OUTPUT THE COMPLETE JSON. Do not stop mid-generation.
"""
...
Now output the complete JSON quiz with ALL questions:
"""