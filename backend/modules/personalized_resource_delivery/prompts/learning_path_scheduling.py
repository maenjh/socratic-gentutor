    ...
    "learning_path": [
        {
            "id": "Session 1",
            "title": "Session Title",
            "abstract": "Brief overview of the session content (max 50 words)",
            "if_learned": false,
...
1. Every string MUST be properly closed with double quotes (")
2. Escape special characters: use \\" for quotes inside strings, \\n for newlines
3. The "abstract" field MUST be ≤ 50 words
4. Each session "title" MUST be ≤ 10 words
...
Generate **4 to 6** sessions (inclusive) so the learner always receives a well-rounded journey.

* **Learner Profile**: {learner_profile}

Remember: Keep abstracts ≤ 50 words, titles ≤ 10 words. Return valid JSON only.
"""
